# 🏗️ ASP.NET Core# Clean Architecture + DDD + EDA + Modular Monolith (Demo)

นี่คือโปรเจคสาธิตที่อัปเกรดจาก **Clean Architecture** เป็น **Modular Monolith** โดยยังคงรักษาหลักการ **Domain-Driven Design (DDD)** และใช้ **Event-Driven Architecture (EDA)** สำหรับสื่อสารทั้งภายใน Module (Domain Events) และข้าม Module (Integration Events) 🚀**Product Management System**
